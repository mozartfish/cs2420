...
/**
 * An interface for representing a set of generically-typed items. By definition, a set contains no
 * duplicate items. Note that this interface is much like Java's Set, but simpler.
 *
 * @author Erin Parker
