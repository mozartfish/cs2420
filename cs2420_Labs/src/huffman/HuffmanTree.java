...
public class HuffmanTree {
	...
	static class Node implements Comparable<Node> {
		...
		/**
		 * Method that finds the leftmost node in the trie
		 * @author Pranav Rajan
		 * @version April 16, 2018
		 * @return - the leftmost node in the trie
		 */
    public Node getLeftmost() {
      ...
      return cursor;
		...
		public int compareTo(Node rhs) {
			//TODO: How should nodes in the Priority Queue be compared?
    ...
    //create an arraylist to store the bytes
   ...
   * DECOMPRESSION
   *
   * <p>Returns the character for the bit code, by traversing the path from the root of the tree to
   * the character's leaf node. A 0 in the code causes the path to go through a left child, and a 1
   * in the code causes the path to go through a right child.
   *
