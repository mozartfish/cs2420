...
public class SpellChecker {
  ...
  public List<String> spellCheck(File documentFile) {
    ...
    //stores a list of words that are read from a file. Ignores all symbols, digits, and digits
    List<String> wordsToCheck = readFromFile(documentFile);

    //create a new list to store all the misspelled words
    List<String> misspelledWords = new ArrayList<String>();

    //look through all the words in the file and see if they match with the words in the dictionary
