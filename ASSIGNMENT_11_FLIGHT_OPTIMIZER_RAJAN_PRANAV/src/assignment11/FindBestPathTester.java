 ...
 *
 * <p>You will still be required to write JUnit tests to test your program.
 *
...
public class FindBestPathTester {
  ...
  public static void main(String[] args) {
    ...
    BestPath shortestDistancePath2 =
        airportGraph.getBestPath("SFO", "DFW", FlightCriteria.DISTANCE, "DL");
