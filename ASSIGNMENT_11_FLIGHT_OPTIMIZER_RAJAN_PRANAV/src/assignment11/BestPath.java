...
public class BestPath {
   ...
   * want the path between SLC and MEM it should have SLC (index 0), MEM (index 1). If there are lay
   * overs it should include them in between (turns out you can fly to Memphis from here directly).
   */
